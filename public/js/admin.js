(function () {
  ...
  function renderApis(apis) {
    ...
    if (!apis.length) {
      listEl.innerHTML = `<div class="empty-state">
        ...
        <p>No APIs found in the system.</p>
      </div>`;
      return;
    }
      ...
      card.innerHTML = `
        <div class="api-card-info">
          ...
          <div class="api-card-meta">
            <span class="badge badge-info">Owner: ${a.ownerName}</span>
  ...
  async function openEditDialog(id) {
    ...
    const found = (data.apis || []).find(a => a.id === id);
    if (!found) return;
  ...
  function openDeleteDialog(id) { editingId = id; openDialog('delete-dialog'); }
  function openResetDialog(id) { editingId = id; openDialog('reset-dialog'); }
